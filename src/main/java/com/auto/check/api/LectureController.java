...
import com.auto.check.service.RegistrationService;
import com.auto.check.api.dto.CreateLectureRequestDTO;
import com.auto.check.api.dto.LectureInfoCreateRequestDTO;
...
public class LectureController {
    ...
    public ResponseEntity getLectureInfo(@RequestParam(value="lectureId") Long lectureId){
        return new ResponseEntity(ResponseData.of(lectureService.getLectureInfoList(lectureId), HttpStatus.OK), HttpStatus.OK);
    }
    ...
    public ResponseEntity getUserLectureList(){
        return new ResponseEntity(ResponseData.of(lectureService.findUserLectureList(), HttpStatus.OK), HttpStatus.OK);
    }
    ...
    public ResponseEntity singUpClass(@RequestParam Long lectureId){
        registrationService.singUpClass(lectureId);
